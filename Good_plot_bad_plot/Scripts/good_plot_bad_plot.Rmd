...
- Missing key factors that make this data useful
...
ggplot(weather_forecasts_HI_counts, aes(x = reorder(forecast_outlook, -count), y = 1, fill = count)) +
  ...
  labs(title = expression(paste("😎 Weather Forecast Counts 🌧")),
...
- Aesthetics (font, colors, sizing) do not take away from the data being conveyed
